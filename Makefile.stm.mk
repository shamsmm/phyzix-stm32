...
CFLAGS=-ggdb -Wl,-Map=$(BINDIR)/output.map -ffunction-sections -fdata-sections -Wl,--gc-sections -mthumb -mcpu=cortex-m3 -O0 -fno-rtti -fno-exceptions -g0 -nostdlib -nodefaultlibs -nostartfiles -ffreestanding $(INCLUDES)
CPPFLAGS=
